          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              ...
              <div style={{ height: '8px', background: 'var(--border-subtle)', borderRadius: '4px', overflow: 'hidden' }}>
                <div style={{ width: `${(engTasks / tasks.length) * 100}%`, height: '100%', background: '#fb923c' }} />
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ height: '8px', background: 'var(--border-subtle)', borderRadius: '4px', overflow: 'hidden' }}>
                <div style={{ width: `${(stTasks / tasks.length) * 100}%`, height: '100%', background: '#22d3ee' }} />
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ height: '8px', background: 'var(--border-subtle)', borderRadius: '4px', overflow: 'hidden' }}>
                <div style={{ width: `${(oheTasks / tasks.length) * 100}%`, height: '100%', background: '#fde047' }} />
              </div>
            </div>
          </div>
        </div>
